...
export default function Home() {
  ...
  return (
    <>
      {/* Start Hero Section */}
      <Hero
        title="Innova Center <br/> Development  "
        subtitle=" Expanding your businesses into the metaverse and building diverse economic ecosystems & innovative Deep-Tech solutions. Explore, Scale and Build your start-ups and businesses with Metalok " 
        btnText="Get a Quote"
        btnLink="/contact"
      ...
      <Div className="container">
        ...
        Remodel your dream project in the Virtual World through our innovative and state-of-the-art approach to technologies & Concepts 
        </h2>
        <Spacing lg="70" md="70" />
        <VideoModal
